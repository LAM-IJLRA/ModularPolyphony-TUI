...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 723.0, 131.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 723.0, 165.0, 55.0, 22.0 ],
					"text" : "slices $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.625, 428.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 259.625, 402.184081999999989, 578.0, 22.0 ],
					"text" : "mp.TUI.gridial /gridial_helper @rotatexyz 0 0 0 @scale 0.2 @color 0.4 0.4 1 @slices 12 @position 0.5 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.625, 359.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 259.625, 333.184081999999989, 578.0, 22.0 ],
					"text" : "mp.TUI.gridial /gridial_helper @rotatexyz 0 0 0 @scale 0.2 @color 0.4 1. 0.4 @slices 12 @position -0.5 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 266.625, 279.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "mp.TUI.dial", "@description", "A simple dial.", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 49.0, 251.0, 59.0, 22.0 ],
									"text" : "cursor $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 30.5, 287.0, 59.0, 22.0 ],
									"text" : "LAM.max"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 450.0, 155.0, 169.0, 22.0 ],
									"text" : "mp.TUI.toes 10 /gridial_helper"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mp.TUI.hub /gridial_helper"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.window /gridial_helper @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 253.184081999999989, 228.0, 21.0 ],
					"text" : "jit.gl.render /gridial_helper @ortho 1 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 266.625, 253.184081999999989, 477.0, 22.0 ],
					"text" : "mp.TUI.gridial /gridial_helper @rotatexyz 0 0 0 @scale 0.2 @color 1. 0.4 0.4 @slices 12"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 248.125, 246.092040999999995, 734.125, 246.092040999999995 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 2 ],
					"midpoints" : [ 348.125, 241.193793999999997, 734.125, 241.193793999999997 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 276.125, 308.0, 259.125, 308.0, 259.125, 249.184081999999989, 276.125, 249.184081999999989 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 2 ],
					"midpoints" : [ 495.625, 246.092040999999995, 734.125, 246.092040999999995 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 269.125, 388.0, 252.125, 388.0, 252.125, 329.184081999999989, 269.125, 329.184081999999989 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 269.125, 457.0, 252.125, 457.0, 252.125, 398.184081999999989, 269.125, 398.184081999999989 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 2 ],
					"midpoints" : [ 230.5, 244.193793999999997, 734.125, 244.193793999999997 ],
					"source" : [ "obj-9", 0 ]
				}
