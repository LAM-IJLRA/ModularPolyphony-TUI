...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 149.0, 444.0, 54.0, 22.0 ],
					"text" : "del 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 146.0, 478.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 102.0, 335.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 89.0, 429.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 160.0, 386.0, 100.0, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 168.125, 356.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.5, 457.5, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 465.625, 457.5, 100.0, 35.0 ],
					"text" : "jit.matrix 4 char 1280 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 465.625, 366.0, 204.0, 22.0 ],
					"text" : "jit.gl.asyncread /dial_helper"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 221.0, 432.0, 39.0, 22.0 ],
					"text" : "/ 31."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "mp.TUI.toes 10 /dial_helper"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.window /dial_helper @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 253.184081999999989, 216.0, 33.0 ],
					"text" : "jit.gl.render /dial_helper @ortho 1 @fsaa 1 @erase_color 0 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "anim" ],
					"patching_rect" : [ 266.625, 253.184081999999989, 388.0, 22.0 ],
					"text" : "mp.TUI.dial /dial_helper @rotatexyz 0 0 0 @scale 0.4 @color 1. 0.4 0.4"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 248.125, 246.092040999999995, 645.125, 246.092040999999995 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 2 ],
					"midpoints" : [ 348.125, 241.193793999999997, 645.125, 241.193793999999997 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 2 ],
					"midpoints" : [ 495.625, 246.092040999999995, 645.125, 246.092040999999995 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 2 ],
					"midpoints" : [ 230.5, 244.193793999999997, 645.125, 244.193793999999997 ],
					"source" : [ "obj-9", 0 ]
				}
