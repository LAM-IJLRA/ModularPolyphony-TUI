...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 50.0, 215.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 203.0, 350.0, 88.0, 22.0 ],
					"presentation_rect" : [ 203.0, 350.0, 88.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 216.0, 279.0, 135.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 203.0, 379.0, 50.0, 22.0 ],
					"presentation_rect" : [ 203.0, 379.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 80.0, 158.0, 54.0, 21.0 ],
					"presentation_rect" : [ 80.0, 158.0, 54.0, 21.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 613.625, 170.0, 50.0, 22.0 ],
					"presentation_rect" : [ 613.625, 170.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 561.625, 170.0, 50.0, 22.0 ],
					"presentation_rect" : [ 561.625, 170.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 509.625, 204.0, 123.0, 22.0 ],
					"presentation_rect" : [ 509.625, 204.0, 123.0, 22.0 ],
					"style" : "",
					"text" : "pak dim 3 3"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-16",
					"items" : [ "(off)", ",", "checkbox", ",", "radio" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 350.625, 171.0, 80.375, 22.0 ],
					"presentation_rect" : [ 350.625, 171.0, 80.375, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.625, 204.0, 55.0, 22.0 ],
					"presentation_rect" : [ 350.625, 204.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "mode $1"
				}
...
, 			{
				"box" : 				{
					"args" : [ "mp.TUI.lightgrid", "@description", "A light-weight version of mp.TUI.grid.", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 340.125, 102.0, 157.0, 22.0 ],
									"presentation_rect" : [ 340.125, 102.0, 157.0, 22.0 ],
									"style" : "",
									"text" : "mp.TUI.toes 10 /grid_helper"
								}
...
,
					"patching_rect" : [ 427.125, 130.0, 76.0, 24.0 ],
					"presentation_rect" : [ 427.125, 130.0, 76.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 209.125, 101.0, 237.0, 21.0 ],
					"presentation_rect" : [ 209.125, 101.0, 237.0, 21.0 ],
					"style" : "",
					"text" : "jit.window /grid_helper @fsmenubar 0 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 218.184082, 173.0, 21.0 ],
					"presentation_rect" : [ 9.0, 218.184082, 173.0, 21.0 ],
					"style" : "",
					"text" : "jit.gl.render /grid_helper @ortho 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 440.625, 171.0, 24.0, 24.0 ],
					"presentation_rect" : [ 440.625, 171.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.625, 204.0, 61.0, 22.0 ],
					"presentation_rect" : [ 440.625, 204.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "enable $1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 673.625, 161.0, 142.0, 65.0 ],
					"presentation_rect" : [ 673.625, 161.0, 142.0, 65.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 519.125, 232.092041, 787.5, 232.092041 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 1 ],
					"midpoints" : [ 450.125, 232.092041, 787.5, 232.092041 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 1 ],
					"midpoints" : [ 683.125, 231.592041, 787.5, 231.592041 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 1 ],
					"midpoints" : [ 360.125, 232.092041, 787.5, 232.092041 ],
					"source" : [ "obj-9", 0 ]
				}
