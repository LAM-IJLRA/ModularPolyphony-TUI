...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 269.0, 55.0, 22.0 ],
					"presentation_rect" : [ 326.0, 269.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 326.0, 233.0, 40.0, 22.0 ],
					"presentation_rect" : [ 326.0, 233.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 231.0, 280.368164, 50.0, 22.0 ],
					"presentation_rect" : [ 231.0, 280.368164, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 231.0, 253.184082, 29.0, 22.0 ],
					"presentation_rect" : [ 231.0, 253.184082, 29.0, 22.0 ],
					"style" : "",
					"text" : "sqrt"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 231.0, 130.0, 230.0, 95.0 ],
					"presentation_rect" : [ 231.0, 130.0, 230.0, 95.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 231.0, 234.0, 80.0, 13.0 ],
					"presentation_rect" : [ 231.0, 234.0, 80.0, 13.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 306.0, 56.0, 22.0 ],
					"presentation_rect" : [ 231.0, 306.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "meter $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 101.0, 45.0, 45.0 ],
					"presentation_rect" : [ 89.0, 101.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"args" : [ "mp.TUI.vumeter", "@description", "A simple VU-meter.", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 376.000092, 144.0, 181.0, 22.0 ],
									"presentation_rect" : [ 376.000092, 144.0, 181.0, 22.0 ],
									"style" : "",
									"text" : "mp.TUI.toes 10 /vumeter_helper"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "mp.TUI.hub /vumeter_helper"
								}
...
,
					"patching_rect" : [ 684.125, 130.0, 76.0, 24.0 ],
					"presentation_rect" : [ 684.125, 130.0, 76.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 9.0, 101.0, 73.0, 45.0 ],
					"presentation_rect" : [ 9.0, 101.0, 73.0, 45.0 ],
					"style" : "",
					"text" : "OFF",
					"texton" : "ON",
					"usebgoncolor" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 209.125, 101.0, 494.0, 21.0 ],
					"presentation_rect" : [ 209.125, 101.0, 494.0, 21.0 ],
					"style" : "",
					"text" : "jit.window /vumeter_helper @fsmenubar 0 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 222.184082, 194.0, 21.0 ],
					"presentation_rect" : [ 9.0, 222.184082, 194.0, 21.0 ],
					"style" : "",
					"text" : "jit.gl.render /vumeter_helper @ortho 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 187.0, 64.0, 21.0 ],
					"presentation_rect" : [ 9.0, 187.0, 64.0, 21.0 ],
					"style" : "",
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 476.625, 255.0, 24.0, 24.0 ],
					"presentation_rect" : [ 476.625, 255.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 476.625, 290.0, 61.0, 22.0 ],
					"presentation_rect" : [ 476.625, 290.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "enable $1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 609.125, 248.0, 141.5, 64.0 ],
					"presentation_rect" : [ 609.125, 248.0, 141.5, 64.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 231.0, 335.184082, 397.0, 22.0 ],
					"presentation_rect" : [ 231.0, 335.184082, 397.0, 22.0 ],
					"style" : "",
					"text" : "mp.TUI.vumeter /vumeter_helper @name myVUmeter @scale 0.2 0.75 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 486.125, 323.092041, 618.5, 323.092041 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 1 ],
					"midpoints" : [ 618.625, 325.592041, 618.5, 325.592041 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 618.5, 367.184082, 604.5625, 367.184082, 604.5625, 237.0, 618.625, 237.0 ],
					"source" : [ "obj-30", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 1 ],
					"midpoints" : [ 240.5, 331.092041, 618.5, 331.092041 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"name" : "mp.TUI.vumeter.cell.p.maxpat",
				"bootpath" : "~/Documents/Max 7/Packages/ModularPolyphony-TUI/patchers",
				"patcherrelativepath" : "../patchers",
				"type" : "JSON",
				"implicit" : 1
