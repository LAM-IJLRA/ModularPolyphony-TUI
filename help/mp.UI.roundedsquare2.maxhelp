...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 616.125, 231.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 616.125, 266.0, 61.0, 22.0 ],
					"text" : "fill $1"
				}
...
, 			{
				"box" : 				{
					"args" : [ "mp.UI.roundedsquare2", "@description", "A UI rounded square.", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "mp.UI.roundedsquare2 /roundedsquare_helper @scale 0.4 0.3 @line_width 4 @rounded 0.3"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "mp.UI.roundedsquare2.maxpat",
