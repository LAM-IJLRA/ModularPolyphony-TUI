...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.625, 287.0, 94.0, 22.0 ],
					"presentation_rect" : [ 266.625, 287.0, 94.0, 22.0 ],
					"style" : "",
					"text" : "1140 value -2 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 393.0, 188.0, 50.0, 22.0 ],
					"presentation_rect" : [ 393.0, 188.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 341.0, 188.0, 50.0, 22.0 ],
					"presentation_rect" : [ 341.0, 188.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 218.0, 123.0, 22.0 ],
					"presentation_rect" : [ 289.0, 218.0, 123.0, 22.0 ],
					"style" : "",
					"text" : "pak dim 2 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 457.125, 183.0, 24.0, 24.0 ],
					"presentation_rect" : [ 457.125, 183.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 457.125, 218.0, 61.0, 22.0 ],
					"presentation_rect" : [ 457.125, 218.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "enable $1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 531.125, 176.0, 141.5, 64.0 ],
					"presentation_rect" : [ 531.125, 176.0, 141.5, 64.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 266.625, 253.184082, 283.0, 22.0 ],
					"presentation_rect" : [ 266.625, 253.184082, 283.0, 22.0 ],
					"style" : "",
					"text" : "mp.TUI.hexagrid /hexagrid_helper @scale 0.1 0.1 0"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 376.000061, 138.0, 183.0, 22.0 ],
									"presentation_rect" : [ 376.000061, 138.0, 183.0, 22.0 ],
									"style" : "",
									"text" : "mp.TUI.toes 10 /hexagrid_helper"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "s /hexagrid_helper/global/edit"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "mp.TUI.hub /hexagrid_helper"
								}
...
,
					"patching_rect" : [ 617.625, 132.0, 76.0, 24.0 ],
					"presentation_rect" : [ 617.625, 132.0, 76.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 209.125, 101.0, 426.0, 21.0 ],
					"presentation_rect" : [ 209.125, 101.0, 426.0, 21.0 ],
					"style" : "",
					"text" : "jit.window /hexagrid_helper @mousewheel 1 @idlemouse 1 @fsmenubar 0 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 253.184082, 203.0, 21.0 ],
					"presentation_rect" : [ 9.0, 253.184082, 203.0, 21.0 ],
					"style" : "",
					"text" : "jit.gl.render /hexagrid_helper @ortho 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 466.625, 246.092041, 540.125, 246.092041 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 1 ],
					"midpoints" : [ 540.625, 245.592041, 540.125, 245.592041 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 276.125, 280.592041, 351.125, 280.592041 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 540.125, 285.184082, 524.375, 285.184082, 524.375, 164.0, 540.625, 164.0 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 1 ],
					"midpoints" : [ 298.5, 246.092041, 540.125, 246.092041 ],
					"source" : [ "obj-7", 0 ]
				}
