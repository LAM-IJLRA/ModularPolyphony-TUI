...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "mp.TUI.slider", "@obj-desc", "A simple slider." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "jit.window /slider_helper @mousewheel 1 @idlemouse 1 @size 320 240 @fsmenubar 0 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "mp.TUI.slider /slider_helper @scale 1 0.3 0"
				}
