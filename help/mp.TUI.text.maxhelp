...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 177.625, 222.184081999999989, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "mp.TUI.text", "@description", "A simple text wrapper.", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "mp.TUI.toes 10 /text_helper"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "s /text_helper/global/edit"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 141.125, 98.0, 236.0, 21.0 ],
					"text" : "jit.window /text_helper @fsmenubar 0 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 223.184081999999989, 136.0, 21.0 ],
					"text" : "jit.gl.render /text_helper"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 177.625, 178.184081999999989, 547.0, 22.0 ],
					"text" : "mp.TUI.text /text_helper @scale 0.2 0.2 @position -0.3 0 0 @caption text button @caption scale 0.25"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 548.625, 171.092040999999995, 715.125, 171.092040999999995 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 715.125, 217.184081999999989, 607.125, 217.184081999999989, 607.125, 97.0, 630.125, 97.0 ],
					"source" : [ "obj-30", 2 ]
				}
