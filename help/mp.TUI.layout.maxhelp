...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 768.0, 126.184081999999989, 33.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 601.5, 403.5, 100.0, 22.0 ],
					"text" : "prepend color"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 601.5, 347.0, 171.0, 50.0 ],
					"saturation" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 567.5, 280.684081999999989, 100.0, 22.0 ],
					"text" : "prepend color"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 567.5, 224.184081999999989, 171.0, 50.0 ],
					"saturation" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 505.5, 340.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 505.5, 368.184081999999989, 83.0, 22.0 ],
					"text" : "numsliders $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 459.0, 231.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 459.0, 261.0, 50.0, 22.0 ],
					"text" : "edit $1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "mp.TUI.2Dcursor 10 /layout_helper @position 0.6 0 0 @scale 0.3 0.2 @color 1 1 1 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 9.0, 368.184081999999989, 472.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 628.0, 86.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 627.0, 126.184081999999989, 52.0, 22.0 ],
					"text" : "store $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 565.0, 126.184081999999989, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 535.0, 126.184081999999989, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 536.0, 163.184081999999989, 162.0, 22.0 ],
					"text" : "mp.TUI.layout /layout_helper"
				}

			}
, 			{
				"box" : 				{
					"args" : [ "mp.TUI.layout", "@description", "Storing and recalling layouts.", "@categories", "system" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 183.0, 142.0, 99.0, 22.0 ],
									"text" : "myCanvas"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mp.TUI.toes 10 /layout_helper"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 50.0, 62.0, 508.000122000000033, 29.0 ],
									"text" : "mp.TUI.hub /layout_helper"
								}
...
,
					"patching_rect" : [ 394.125, 133.0, 76.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 209.125, 101.0, 204.0, 21.0 ],
					"text" : "jit.window /layout_helper @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.gl.render /layout_helper"
				}
