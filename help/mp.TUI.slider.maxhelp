...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "mp.TUI.ribbonslider /slider_helper @scale 1 0.2 0"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 577.125, 285.184082, 558.375, 285.184082, 558.375, 166.0, 577.625, 166.0 ],
					"source" : [ "obj-30", 1 ]
				}
