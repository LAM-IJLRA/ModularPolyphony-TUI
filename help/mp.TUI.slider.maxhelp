...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 224.125, 188.0, 148.0, 22.0 ],
									"presentation_rect" : [ 224.125, 188.0, 148.0, 22.0 ],
									"style" : "",
									"text" : "s /slider_helper/global/edit"
								}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "jit.window /slider_helper @mousewheel 1 @idlemouse 1 @fsmenubar 0 @fsaa 1"
				}
