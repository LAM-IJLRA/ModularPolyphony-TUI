...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 266.625, 264.0, 53.0, 22.0 ],
					"text" : "*~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 266.625, 218.0, 60.0, 22.0 ],
					"text" : "cycle~ 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 557.625, 259.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "mp.UI.wave~", "@description", "Waveform  scope.", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "mp.TUI.toes 10 /wave_helper"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.gl.render /wave_helper @ortho 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 266.625, 296.184081999999989, 237.0, 22.0 ],
					"text" : "mp.UI.wave~ /wave_helper @scale 1 0.2 0"
				}
