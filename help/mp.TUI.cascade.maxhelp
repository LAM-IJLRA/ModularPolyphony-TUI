...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 336.270325000000014, 433.0, 55.0, 22.0 ],
					"text" : "dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 360.020325000000014, 321.5, 114.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 653.020324999999957, 191.5, 141.5, 64.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "mp.TUI.cascade", "@description", "A TUI multi-filters gaph", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 376.000061000000017, 138.0, 191.0, 22.0 ],
									"text" : "mp.TUI.toes 10 /cascade_helper"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "s /cascade_helper/global/edit"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mp.TUI.hub /cascade_helper"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.window /cascade_helper @fsmenubar 0 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 195.184081999999989, 203.0, 21.0 ],
					"text" : "jit.gl.render /cascade_helper @ortho 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.207274999999981, 351.5, 83.0, 22.0 ],
					"text" : "loadmess -24"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 242.729674999999986, 204.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.729674999999986, 233.5, 63.0, 22.0 ],
					"text" : "enable $1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 336.270325000000014, 390.5, 136.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 336.270325000000014, 351.5, 137.75, 22.0 ],
					"text" : "biquad~"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "mp.TUI.cascade /cascade_helper @scale 1 0.5 0 @nbpoints 200 @type 1 @gain 12 @freq 2000 @bw 0.1"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 498.707274999999981, 381.5, 345.770325000000014, 381.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 662.520324999999957, 303.0, 648.572662000000037, 303.0, 648.572662000000037, 173.315918000000011, 662.520324999999957, 173.315918000000011 ],
					"source" : [ "obj-133", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 69.5, 412.0, 309.63516199999998, 412.0, 309.63516199999998, 340.5, 345.770325000000014, 340.5 ],
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-133", 1 ],
					"midpoints" : [ 252.229674999999986, 263.886276000000009, 662.520324999999957, 263.886276000000009 ],
					"source" : [ "obj-9", 0 ]
				}
