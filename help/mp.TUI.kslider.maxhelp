...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "mp.TUI.kslider", "@obj-desc", "A key-slider." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 224.125, 188.0, 154.0, 22.0 ],
									"presentation_rect" : [ 224.125, 188.0, 154.0, 22.0 ],
									"style" : "",
									"text" : "s /kslider_helper/global/edit"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 245.0, 89.0, 21.0 ],
					"presentation_rect" : [ 32.0, 245.0, 89.0, 21.0 ],
					"style" : "",
					"text" : "s /kslider_helper"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "jit.window /kslider_helper @mousewheel 1 @idlemouse 1 @size 640 480 @fsmenubar 0 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 285.0, 186.0, 21.0 ],
					"presentation_rect" : [ 9.0, 285.0, 186.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 399.125, 403.184082, 45.0, 45.0 ],
					"presentation_rect" : [ 399.125, 403.184082, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 399.125, 360.184082, 136.0, 30.0 ],
					"presentation_rect" : [ 399.125, 360.184082, 136.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 399.125, 332.184082, 106.0, 22.0 ],
					"presentation_rect" : [ 399.125, 332.184082, 106.0, 22.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 366.0, 189.0, 33.0, 22.0 ],
									"presentation_rect" : [ 366.0, 189.0, 33.0, 22.0 ],
									"style" : "",
									"text" : "* 40."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 366.0, 240.0, 96.0, 22.0 ],
									"presentation_rect" : [ 366.0, 240.0, 96.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 237.0, 210.0, 82.0, 22.0 ],
									"presentation_rect" : [ 237.0, 210.0, 82.0, 22.0 ],
									"style" : "",
									"text" : "prepend state"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 237.0, 157.0, 150.5, 22.0 ],
									"presentation_rect" : [ 237.0, 157.0, 150.5, 22.0 ],
									"style" : "",
									"text" : "t i i"
								}
...
,
									"patching_rect" : [ 71.0, 240.0, 48.0, 22.0 ],
									"presentation_rect" : [ 71.0, 240.0, 48.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 71.0, 329.0, 45.0, 22.0 ],
									"presentation_rect" : [ 71.0, 329.0, 45.0, 22.0 ],
									"style" : "",
									"text" : "zl rot 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 71.0, 296.0, 421.0, 22.0 ],
									"presentation_rect" : [ 71.0, 296.0, 421.0, 22.0 ],
									"style" : "",
									"text" : "zl join"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 71.0, 123.0, 269.0, 22.0 ],
									"presentation_rect" : [ 71.0, 123.0, 269.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 71.0, 94.0, 421.0, 22.0 ],
									"presentation_rect" : [ 71.0, 94.0, 421.0, 22.0 ],
									"style" : "",
									"text" : "zl ecils 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 71.0, 61.0, 49.0, 22.0 ],
									"presentation_rect" : [ 71.0, 61.0, 49.0, 22.0 ],
									"style" : "",
									"text" : "zl rot -1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 71.0, 362.0, 30.0, 30.0 ],
									"presentation_rect" : [ 71.0, 362.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 71.0, 24.0, 30.0, 30.0 ],
									"presentation_rect" : [ 71.0, 24.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 399.125, 300.184082, 53.0, 22.0 ],
					"presentation_rect" : [ 399.125, 300.184082, 53.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 743.625, 194.184082, 24.0, 24.0 ],
					"presentation_rect" : [ 743.625, 194.184082, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 743.625, 229.184082, 61.0, 22.0 ],
					"presentation_rect" : [ 743.625, 229.184082, 61.0, 22.0 ],
					"style" : "",
					"text" : "enable $1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 587.625, 191.184082, 141.5, 64.0 ],
					"presentation_rect" : [ 587.625, 191.184082, 141.5, 64.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 209.125, 272.184082, 433.0, 22.0 ],
					"presentation_rect" : [ 209.125, 272.184082, 433.0, 22.0 ],
					"style" : "",
					"text" : "mp.TUI.kslider /kslider_helper @scale 1 0.3 0 @layer 1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-21" : [ "live.gain~[14]", "live.gain~[14]", 0 ],
			"parameterbanks" : 			{
