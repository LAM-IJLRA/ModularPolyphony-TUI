...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "mp.TUI.movie", "@description", "A simple movie player.", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 475.625, 160.0, 91.0, 22.0 ],
					"text" : "read dozer.mov"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 560.625, 218.0, 135.5, 63.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 275.625, 239.184081999999989, 267.0, 35.0 ],
					"text" : "mp.TUI.movie /movie_helper @movie file chickens.mp4 @scale 0.8 0.6 @rotatexyz 0 0 10"
				}
...
, 							{
								"box" : 								{
									...
									"text" : "mp.TUI.toes 10 /movie_helper"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "s /movie_helper/global/edit"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.window /movie_helper @fsmenubar 0 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.gl.render /movie_helper"
				}
