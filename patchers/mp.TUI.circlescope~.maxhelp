...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 596.0, 199.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 595.0, 224.0, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 518.0, 175.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 336.0, 325.0, 81.0, 22.0 ],
					"text" : "loadmess -24"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 276.0, 351.184081999999989, 136.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 276.0, 175.0, 221.0, 95.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 276.0, 378.0, 45.0, 45.0 ]
				}
...
,
					"patching_rect" : [ 239.125, 104.0, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 706.625, 160.0, 76.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 39.0, 131.0, 71.0, 43.0 ],
					"text" : "OFF",
					"texton" : "ON",
					"usebgoncolor" : 1,
					"usetextovercolor" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 239.125, 131.0, 486.5, 21.0 ],
					"text" : "jit.window /circlescope_helper @fsmenubar 0 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 39.0, 255.184081999999989, 209.0, 21.0 ],
					"text" : "jit.gl.render /circlescope_helper @ortho 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 39.0, 220.0, 64.0, 21.0 ],
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 39.0, 188.0, 63.0, 21.0 ],
					"text" : "qmetro 30"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 690.0, 206.0, 141.5, 64.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "anim" ],
					"patching_rect" : [ 296.0, 283.184081999999989, 308.0, 22.0 ],
					"text" : "mp.TUI.circlescope~ /circlescope_helper @scale 1 0.5 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 517.0, 199.5, 77.0, 22.0 ],
					"text" : "framesize $1"
				}
...
, 			{
				"box" : 				{
					"args" : [ "mp.TUI.circlescope~", "@description", "A TUI circle scope", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 594.5, 312.184081999999989, 682.5, 312.184081999999989, 682.5, 195.0, 699.5, 195.0 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"name" : "mp.TUI.circlescope~.maxpat",
				"bootpath" : "~/Documents/Max 7/Packages/ModularPolyphony-TUI/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
