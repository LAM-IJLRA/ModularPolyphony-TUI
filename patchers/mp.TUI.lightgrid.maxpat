    ...
    "patcher": {
        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 471.266663, 295.0, 415.0, 35.0 ],
                    "text": "jit.gl.gridshape #0.slider.node @shape plane @dim 2 2 @poly_mode 1 1 @gridmode 0"
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 51.5, 154.986328, 595.0, 35.0 ],
                                    "text": "jit.gl.gridshape #0.slider.node @shape plane @dim 2 2 @poly_mode 1 1 @name #0.slider/background @gridmode 0"
                                }
                            }
                        ],
                        "lines": [
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-33", 0 ],
                    "midpoints": [ 459.666702, 119.182556, 911.766724, 119.182556 ],
                    "order": 0,
                    "source": [ "obj-14", 1 ]
                }
            },
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-14", 0 ],
                    "midpoints": [ 907.238129, 81.0, 221.666702, 81.0 ],
                    "source": [ "obj-2", 1 ]
                }
            },
            {
