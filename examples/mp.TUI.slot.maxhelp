...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 631.625, 444.0, 60.0, 22.0 ],
					"text" : "sw others"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 466.625, 444.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 466.625, 413.18408203125, 349.0, 22.0 ],
					"text" : "mp.TUI.slot /canvas_helper @scale 0.2 0.2 @position 0.3 -0.3 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.625, 444.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 60.625, 416.18408203125, 353.0, 22.0 ],
					"text" : "mp.TUI.slot /canvas_helper @scale 0.2 0.2 @position -0.3 -0.3 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 631.625, 305.0, 60.0, 22.0 ],
					"text" : "sw others"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 466.625, 305.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.625, 315.0, 60.0, 22.0 ],
					"text" : "sw others"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 466.625, 274.18408203125, 345.0, 22.0 ],
					"text" : "mp.TUI.slot /canvas_helper @scale 0.2 0.2 @position 0.3 0.3 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.625, 305.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 60.625, 277.18408203125, 349.0, 22.0 ],
					"text" : "mp.TUI.slot /canvas_helper @scale 0.2 0.2 @position -0.3 0.3 0"
				}
...
, 			{
				"box" : 				{
					"args" : [ "mp.TUI.slot", "@description", "DRAFT! slot for drag and drop.", "@categories", "component" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
