...
//
JitterGUITracker.prototype.handleEvent = function(event)
{
	var raystart, rayend;
...
// handle a UI touch.
//
JitterGUIElement.prototype.handle_touch = function(touch)
{
	post ("override handle_touch method of JitterGUIElement to handle touchs.\n");
};
